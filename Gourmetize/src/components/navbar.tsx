...
export default function Navbar() {
  ...
  return (
    <nav className="w-full bg-white dark:bg-green-900 border-b border-slate-200 dark:border-slate-800">
      <div className="max-w-6xl mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <ul className="hidden md:flex gap-8 text-slate-700 dark:text-slate-300 text-sm font-medium">
          <li className="hover:text-amber-500 dark:hover:text-amber-400 cursor-pointer">
            Página inicial
          </li>
          <li className="hover:text-amber-500 dark:hover:text-amber-400 cursor-pointer">
            Sobre
